...
export class OrderDataPage extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  ...
  render() {
    ...
    return (
      <article>
        <Helmet>
          <title>{intl.formatMessage(messages.{{pageNameFullLower}}.header.title)}</title>
          <meta name="description" content={intl.formatMessage(messages.{{pageNameFullLower}}.header.content)} />
        </Helmet>
        <div>
          <Toolbar />
          <DataTable />
